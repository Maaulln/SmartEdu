        ...
        <div className="flex gap-2">
          ...
          <Select value={selectedSort} onValueChange={setSelectedSort}>
            ...
            <SelectContent>
              ...
              <SelectItem value="most_likes">Terbanyak Disukai</SelectItem>
              <SelectItem value="most_replies">Terbanyak Balasan</SelectItem>
              <SelectItem value="most_views">Terbanyak Dilihat</SelectItem>
            </SelectContent>
          </Select>
        </div>
      </div>
